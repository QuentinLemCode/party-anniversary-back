...
type ListOfCurrentUsersPlaylistsResponse =
  PagingObject<PlaylistObjectSimplified>;
 ...
 */
type UploadCustomPlaylistCoverImageReponse =
  UploadCustomPlaylistCoverImageResponse;
...
export interface ContextObject {
   ...
   * The object type.
   */
  type: Exclude<SpotifyCategoryID, Track>;
  /**
   ...
   */
  uri: SpotifyURI<Exclude<SpotifyCategoryID, Track>>;
}
